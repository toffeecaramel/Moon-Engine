...
/**
 * From Doido Engine :D
 * https://github.com/DoidoTeam/FNF-Doido-Engine/blob/main/source/flixel/FlxCamera.hx
 **/
	...
	function updateScrollRect():Void
	{
		...
		if (rect != null)
		{
			...
			flxRect.getRotatedBounds(
				angle,
				FlxPoint.get(FlxMath.lerp(flxRect.left, flxRect.right, 0.5),
				FlxMath.lerp(flxRect.top, flxRect.bottom, 0.5)),
				flxRect
			);
